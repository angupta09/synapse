...
## 0. Name suggestions (pick one)

| Name | Rationale |
|---|---|
| **Pharos** | Ancient lighthouse — "illuminates" treatment options and trial risk before you sail into them. Short, memorable, not generic. |
| **Beacon Rx** | Same guiding-light metaphor, more literally clinical. Reads well on a slide. |
| **Wayfinder** | Patients and R&D teams are both "finding their way" through a fragmented landscape — one word, works across all 3 portals. |
| **TrialLens** | Literal, safe, instantly explains "we look at trial data clearly." Good if judges are skimming fast. |
| **Meridian** | Navigation/mapping metaphor, sounds like enterprise biopharma software already — good for the R&D portal's "landscape mapping" feel. |
| **Sentinel Bio** | Emphasizes the safety/pattern-detection angle (learning from failures, flagging risk) — strong if you lean into Portal 2. |
| **Evidentia** | Directly signals "every claim is evidence-backed," which is your core differentiator vs. a generic chatbot. |
| **Compass Rx** | Simple, on-the-nose "helps you navigate treatment/trial decisions." Slightly generic but very legible instantly. |

**Recommendation:** *Pharos* or *Wayfinder* — both carry the "guide through fragmented, high-stakes information" story that ties all three portals and the evidence-citation theme together in one word. Pick whichever the team says out loud most naturally under pressure during the demo.
